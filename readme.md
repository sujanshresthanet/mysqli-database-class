[![Latest Stable Version](http://poser.pugx.org/sujanshresthanet/mysqli-database-class/v)](https://packagist.org/packages/sujanshresthanet/mysqli-database-class) [![Total Downloads](http://poser.pugx.org/sujanshresthanet/mysqli-database-class/downloads)](https://packagist.org/packages/sujanshresthanet/mysqli-database-class) [![Latest Unstable Version](http://poser.pugx.org/sujanshresthanet/mysqli-database-class/v/unstable)](https://packagist.org/packages/sujanshresthanet/mysqli-database-class) [![License](http://poser.pugx.org/sujanshresthanet/mysqli-database-class/license)](https://packagist.org/packages/sujanshresthanet/mysqli-database-class) [![PHP Version Require](http://poser.pugx.org/sujanshresthanet/mysqli-database-class/require/php)](https://packagist.org/packages/sujanshresthanet/mysqli-database-class) [![Dependents](http://poser.pugx.org/sujanshresthanet/mysqli-database-class/dependents)](https://packagist.org/packages/sujanshresthanet/mysqli-database-class)
...
### Objects mapping
mysqliDbObject.php is an object mapping library built on top of mysqliDb to provide model representation functionality.
See <a href='mysqliDbObject.md'>mysqliDbObject manual for more information</a>
