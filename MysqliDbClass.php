...
class MysqliDbClass
{
     ...
     *
     * @return MysqliDbClass Returns the current instance.
     */
     ...
     *
     * @return array|MysqliDbClass Contains the returned rows from the select query.
     * @throws Exception
     */
    ...
    public function getOne($tableName, $columns = '*')
    {
        ...
        if ($res instanceof MysqliDbClass) {
            return $res;
    ...
    public function _buildDataPairs($tableData, $tableColumns, $isInsert)
    {
        foreach ($tableColumns as $column) {
            ...
            // Subquery value
            if ($value instanceof MysqliDbClass) {
     ...
     *
     * @return MysqliDbClass new mysqlidb object
     */
